...
using HotelBookingClean.Application.TodoItems.Commands.UpdateTodoItemDetail;
using HotelBookingClean.Application.TodoItems.Queries.GetTodoItemsWithPagination;
